...
class NaiveAccAssessment():
    ...
    def users_accuracy(self, k):
        correct = self.error_matrix.loc[k, k]
        incorrect = self.error_matrix.loc[k, :].sum()
